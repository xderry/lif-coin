...
class MinePacket extends Packet {
  constructor(data, target, min, max, pow_net_type) {
    super();
    ...
    this.pow_net_type = pow_net_type||'';
  }

  getSize() {
    return 120+encoding.sizeVarString(this.pow_net_type, 'utf8');
  }
  ...
  toWriter(bw) {
    ...
    bw.writeVarString(this.pow_net_type, 'utf8');
    return bw;
  }
  ...
  fromRaw(data) {
    ...
    this.min = br.readU32();
    this.max = br.readU32();
    this.pow_net_type = br.readVarString('utf8');
    return this;
  }
