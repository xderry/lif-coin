...
network.types = ['main', 'testnet', 'regtest', 'simnet', 'lifmain'];
...
lifmain.keyPrefix = {
  ...
  xpubkey: 0x019da4e0, // creates Lpub prefix
  xprivkey: 0x019da380, // creates Lprv prefix
  xpubkey58: 'Lpub', // result of base58 4 version bytes
  xprivkey58: 'Lprv', // result of base58 4 version bytes
  coinType: 0, // 12 'L'? 18 DGC Digital coin? 42 decred? 67 nexus?
};
