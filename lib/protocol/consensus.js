...
exports.pow_hash256_digest = data=>hash256.digest(data);
exports.is_net = 'btc';
exports.set_net = function(net){
  net ||= 'btc';
  switch (net){
  case 'btc':
    consensus.pow_hash256_digest = data=>hash256.digest(data); 
    consensus.is_net = 'btc';
    break;
  case 'lif':
    consensus.pow_hash256_digest = data=>hash256lif.digest(data);
    consensus.is_net = 'lif';
    break;
  default:
