...
exports.pow_hash256 = hash256;
exports.net_type = 'btc';
exports.set_type = function(net){
  net ||= 'btc';
  switch (net){
  case 'btc':
    consensus.pow_hash256 = hash256;
    consensus.net_type = 'btc';
    break;
  case 'lif':
    consensus.pow_hash256 = hash256lif;
    consensus.net_type = 'lif';
    break;
  default:
    throw Error('invalid network');
  }
};
exports.pow_by_net_type = function(net){
  switch (net||consensus.net_type){
  case 'btc': return hash256;
  case 'lif': return hash256lif;
  default: throw Error('invalid network');
  }
};
